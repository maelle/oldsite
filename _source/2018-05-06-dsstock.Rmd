...
limited_get <- ratelimitr::limit_rate(httr::GET,
                                      ratelimitr::rate(3, 60),# not more than 200 times ah hour
...
I got `r length(unique(ds_stock$href))` unique pictures.
