...
And now, because I do not want you to think I'm now as depressed as a Black Metal Cat, I'll end this post by showing you a few replies thanks to the brand new `rtweet::tweet_shot` function added in the dev version of `rtweet` by [Bob Rudis](https://twitter.com/hrbrmstr?lang=en) after he saw my [#best9of2017 post](http://www.masalmon.eu/2017/12/30/best9of2017/). I resorted to saving the files by hand but in a normal Rmd, not in a website, the images (`magick` objects) actually render very well. [Head to Twitter](https://twitter.com/cheerful_doggos/with_replies) to see the rest!
