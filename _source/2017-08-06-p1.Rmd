---
layout: post
title: "Who are the Swedish radio P1 summer guests?"
comments: true
---
...
```{r}
# all summer guests
sommargaester <- readr::read_csv("p1sommar.csv", col_names = FALSE, 
