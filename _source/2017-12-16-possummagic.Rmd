...
`adelaide$annotations.flag` gives me `r adelaide$annotations.flag`. But still, a cool feature... among other tons of more useful features OpenCage has like the [`abbr` parameter to get shorter names](http://blog.opencagedata.com/post/160294347883/shrtr-pls).
