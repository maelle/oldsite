...
get_followers_and_wait <- function(user){
  ...
  if(rates$remaining == 0){
    Sys.sleep(as.numeric(rates$reset)*60)
  }
...
In the last part of the post I got a data.frame but what I need for using a clustering function is a dissimilarity matrix.