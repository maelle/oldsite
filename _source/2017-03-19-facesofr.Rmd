...
users <- readr::read_csv("data/2017-03-19-facesofr_users.csv")
```
...
I got `r length(dir("data/2017-03-19-facesofr_users_images/"))` images. 
...
![](2017-03-19-facesofr.jpg)


Now you can try doing the same with your followers, the people you follow, or make a doormat with base plot advocates.