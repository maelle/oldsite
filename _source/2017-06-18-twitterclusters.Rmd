...
```{r}
compute_distance <- function(user1, user2, 
...
```{r}
followers_distances <- sapply(followers$user_id[1:10], function(x) sapply(followers$user_id[1:10], compute_distance,
                                                                          followers_followers = followers_followers))
  print(followers_distances)
```
