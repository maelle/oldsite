...
And then I could use [`magick`](https://github.com/ropensci/magick)! Note, I could have packed the whole code of the post in a single function, but I wanted to progressively build the card (compliments, then colours, then the image).
...
create_card <- function(who, compliments){
  ...
  magick::image_blank(color = background)
}
