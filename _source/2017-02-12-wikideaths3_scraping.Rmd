...
In the table I have information about `r nrow(deaths)` notable deaths. I know the age of `r round(sum(!is.na(deaths$age))/nrow(deaths), digits = 3)*100`% of them, a country or nation for `r round(sum(!is.na(deaths$country))/nrow(deaths), digits = 3)*100`% of them. Not too bad I think! It was then time to stop scraping webpages and to start digging into the data... [Who were these people?](http://www.masalmon.eu/2017/02/12/wikideaths2_population/) and [How bad was 2016?](http://www.masalmon.eu/2017/02/12/wikideaths1_ts/)
