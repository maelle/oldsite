...
```{r, echo = FALSE}
load("data/2016-10-02-first7jobs-repost_first7jobs.RData")
load("data/2016-10-02-first7jobs-repost_parsed_first7jobs.RData")
```
...
library("ggplot2")
library("viridis")
load("data/2016-10-02-first7jobs-repost_output.RData")
load("data/2016-10-02-first7jobs-repost_parsed_first7jobs.RData")
```
...
readr::read_csv("data/2016-10-02-first7jobs-repost_keywords_by_industry.csv") %>%
  group_by(label) %>%
  arrange(count) %>%
